// Rewrite of the game's "Custom/Fake3Dspec No Lightmap" for GLES3.
// Custom/Fake3Dspec without the lightmap.
Shader "Custom/Fake3Dspec No Lightmap" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			v2f vert (appdata v) {
				...
				// The original skips the saturate here; clamping avoids pow() of a negative.
